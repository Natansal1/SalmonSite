...
const DbInfo: StoryType[] = [
   {
      ...
      content:
         "לכבוד יום ההולדת שלך הראשון בו מעמדך השתנה ומאדם העומד בפני עצמו אתה קשור לעזר כנגדו...",
      members: [],
   ...
   },
   {
      ...
      content:
         'עירית היקרה שלנו... זה לא יאומן ואפילו מופלא איך מתגלה אופיה של ילדה כבר מגיל שנה... ',
      members: [],
   },
   {
    _id: "",
...
const Congratulations: React.FC = () => {
   return (
      <div className="page congrats_page">
         {DbInfo.map((e, index) => (
            <CongratsItem
               key={index}
               story={e}
